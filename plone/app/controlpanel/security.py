...
class SecurityControlPanelAdapter(SchemaAdapterBase):
    ...
    def __init__(self, context):
        ...
        self.enable_self_reg = ProxyFieldProperty(ISecuritySchema['enable_self_reg'])
        self.enable_user_pwd_choice = ProxyFieldProperty(ISecuritySchema['enable_user_pwd_choice'])
        self.enable_user_folders = ProxyFieldProperty(ISecuritySchema['enable_user_folders'])
        self.allow_anon_views_about = ProxyFieldProperty(ISecuritySchema['allow_anon_views_about'])
        ...
        def get_allow_anon_views_about(self):
            return self.site_properties.allowAnonymousViewAbout

        def set_allow_anon_views_about(self, value):
            self.site_properties.allowAnonymousViewAbout = value
